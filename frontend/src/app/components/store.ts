 ...
 * (the input handler, the sidebar menu) without prop drilling. Components read
 * it through `useChatStore`, which wraps `useSyncExternalStore`: the server
...
import { AgentStep, settleSteps } from "./pipeline";
